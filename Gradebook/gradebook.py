...
gradebook2 = [[61, 74, 69, 62, 72, 66, 73, 65, 60, 63, 69, 63, 62, 61, 64],
...
gradebook3 = [[100, 100, 100, 96],
            [97, 87, 92, 88],
            [91, 90, 92, 91]]

assignment_average = [sum(i)/len(i) for i in zip(*gradebook2)]
student_average = [sum(i)/len(i) for i in gradebook2]
print("Assignment Averages:")
for x in range(len(assignment_average)): 
    print("Assignment ", (x+1),": ","{:.2f}".format(assignment_average[x]), sep='')
print("\nStudent Averages:")
for x in range(len(student_average)): 
    print("Student ", (x+1), ": ", "{:.2f}".format(student_average[x]), sep='')